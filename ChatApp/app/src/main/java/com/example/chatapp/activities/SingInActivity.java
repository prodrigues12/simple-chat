...
public class SingInActivity extends AppCompatActivity {
    ...
    private void setListener() {
        ...
        //   binding.buttonSingIn.setOnClickListener(v -> addDataToFirebase());
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful() && task.getResult() !=null
                        ...
                        loading(false);
                        showToast("Erro ao fazer o login");
                    }
                });
    ...
    private void addDataToFirebase(){
        ...
        data.put("first_name", "Paulino");
        data.put("second_name", "Rodrigues");
        databse.collection("users")
                .add(data)
                .addOnSuccessListener(documentReference -> {
                    Toast.makeText(getApplicationContext(), "Dados inseridos", Toast
                    .LENGTH_SHORT).show();
